...
\textbf{Mô hình Embedding:} \texttt{models/gemini-embedding-2} (Google Generative AI) --- tạo ra vector nhúng cho mỗi tài liệu bệnh học và cho câu truy vấn khi chẩn đoán.
...
\texttt{embedding} & \texttt{List[float]} & Vector từ gemini-embedding-2 \\
\bottomrule
\end{tabular}
\end{table}
