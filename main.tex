...
\usepackage{url}
\usepackage{hyperref}
\usepackage{amssymb}    % \mathbb{R} and other math symbols
\usepackage{booktabs}
\usepackage{tabularx}
\usepackage{array}
\usepackage{float}
...
\bibitem{irri_rkb}
International Rice Research Institute (IRRI). (2024). \textit{Rice Knowledge Bank: Rice Diseases}. IRRI. Truy cập: \url{https://www.knowledgebank.irri.org/training/fact-sheets/pest-management/diseases}.

\bibitem{ou1985}
Ou, S. H. (1985). \textit{Rice Diseases} (2nd ed.). Commonwealth Agricultural Bureaux, Farnham Royal, UK. 380 pp.

\bibitem{savary2019}
Savary, S., Willocquet, L., Pethybridge, S. J., Esker, P., McRoberts, N., \& Nelson, A. (2019). The global burden of pathogens and pests on major food crops. \textit{Nature Ecology \& Evolution}, 3(3), 430--439. \url{https://doi.org/10.1038/s41559-018-0793-y}.

\bibitem{ninoliu2006}
Niño-Liu, D. O., Ronald, P. C., \& Bogdanove, A. J. (2006). \textit{Xanthomonas oryzae} pathovars: model pathogens of a model crop. \textit{Molecular Plant Pathology}, 7(5), 303--324. \url{https://doi.org/10.1111/j.1364-3703.2006.00344.x}.

\bibitem{mew1994}
Mew, T. W., \& Misra, J. K. (1994). \textit{A Manual of Rice Seed Health Testing}. International Rice Research Institute (IRRI), Los Baños, Philippines.

\bibitem{barnwal2013}
Barnwal, M. K., Kotasthane, A., Magculia, N., Mukherjee, P. K., Savary, S., Sharma, A. K., et al. (2013). A review on crop losses, epidemiology and disease management of rice brown spot to identify research priorities and knowledge gaps. \textit{European Journal of Plant Pathology}, 136(3), 443--457. \url{https://doi.org/10.1007/s10658-013-0195-6}.

\bibitem{azzam2002}
Azzam, O., \& Chancellor, T. C. B. (2002). The biology, epidemiology, and management of rice tungro disease in Asia. \textit{Plant Disease}, 86(2), 88--100. \url{https://doi.org/10.1094/PDIS.2002.86.2.88}.

\bibitem{hibino1996}
Hibino, H. (1996). Biology and epidemiology of rice viruses. \textit{Annual Review of Phytopathology}, 34, 249--274. \url{https://doi.org/10.1146/annurev.phyto.34.1.249}.
